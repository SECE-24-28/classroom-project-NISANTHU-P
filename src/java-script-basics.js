...
// for (let i = 0; i < _arrObject.length; i++) {
//   console.log("Name:", _arrObject[i].name);
//   console.log("Mark:", _arrObject[i].mark);
//   console.log("Address:", _arrObject[i].address);
// }
// _arrObject.map((item, index) => {
